...
namespace Scrummie.API.Bot
{
    ...
    public class Bot
    {
        ...
        /// </summary>
        /// <value>The online meeting.</value>
        ...
        /// <param name="args">
        /// The <see cref="CollectionEventArgs{TEntity}"/> instance containing the event data.
        /// </param>
        ...
        /// <param name="args">
        /// The <see cref="CollectionEventArgs{ICall}"/> instance containing the event data.
        /// </param>
        ...
        /// </summary>
        /// <param name="callLegId">The call leg id.</param>
        /// <returns>The <see cref="ResponderCallHandler"/>.</returns>
        /// <exception cref="KeyNotFoundException">Throws an exception if handler is not found.</exception>
        ...
        private async Task<ICall> RehydrateAndValidateGroupCallAsync(ICommunicationsClient client, ICall call)
        {
            ...
            // Rehydrate here... after this point all the data should be rebuilt This calls: GET
            // /communications/calls/{id} GET /communications/calls/{id}/participants GET /communications/calls/{id}/audioRoutingGroups
            ...
            // Rehydrate here... after this point the participant should be rebuilt. This calls: GET /communications/calls/{id}/participants/{id}
